...
import { GuiLayers, IGuiRegistry, IGuiView, IGuiWindowAgent } from '../contract';
import { TRAIT } from '../trait';
import { GuiAgentBase } from './gui-agent';

class GuiWindowAgent extends GuiAgentBase implements IGuiWindowAgent {
